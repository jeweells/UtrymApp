...
class AttachmentHandler: NSObject{
    ...
    //MARK: - Constants
    struct Constants {
        static let actionFileTypeHeading = "Subir Post"
        static let actionFileTypeDescription = "De dónde deseas elegir el post?"
        static let camera = "Tomar una Foto"
        static let phoneLibrary = "Libreria"
